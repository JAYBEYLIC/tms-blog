...
<!-- Mirrored from layerdrops.com/mixup/mixup-main/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Jan 2023 12:23:14 GMT -->
...
<section class="blog-style-one gray-bg sec-pad">
    <div class="thm-container">
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="single-blog-style-one">
                    <div class="img-box">
                        <img src="img/blog-1-5.jpg" alt="Awesome Image"/>
                        <a href="#" class="read-more">+</a>
                        <div class="date-box">
                            29 APR
                        </div><!-- /.date-box -->
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="single-blog-style-one">
                    <div class="img-box">
                        <img src="img/blog-1-6.jpg" alt="Awesome Image"/>
                        <a href="#" class="read-more">+</a>
                        <div class="date-box">
                            29 APR
                        </div><!-- /.date-box -->
