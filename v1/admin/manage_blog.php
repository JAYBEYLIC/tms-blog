...
$where = [];
$content = selectContent($conn,'blogs',$where);
                ...
                <div class="row align-items-center">
                  <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                      ...
                      <li class="breadcrumb-item"><a href="#!">View Blogs</a></li>
                    </ul>
                  </div>
                </div>
              </div>
                        ...
                        <tbody>
                          ...
                          <?php foreach ($content as $key => $value) { ?>
                            <tr>
                              ...
                              <td><a href="/change-image?id=<?php echo $value['id'] ?>&data=blogs&location=admin-view-blog"> <img src="/<?php echo $value['thumbnail'] ?>" alt="" width="100" height="70"></a> </td>
                              <td><span><?php echo $value['visibility'] ?></span>
                                <br>
                                <a href="/updateContent.php?id=<?php echo $value['id'] ?>&visibility=show&data=blogs"><button type="button" class="btn btn-success btn-sm"><i class="feather feather icon-eye"></i>Show</button></a>
                                <a href="/updateContent.php?id=<?php echo $value['id'] ?>&visibility=hide&data=blogs"><button type="button" class="btn btn-warning btn-sm"><i class="feather feather icon-eye-off"></i>Hide</button></a>
                              </td>
                              <td> <a href="/admin-edit-content?id=<?php echo $value['id'] ?>&data=blogs&location=admin-view-blog"><button type="button" class="btn btn-primary"><i class="feather feather icon-edit"></i>Edit</button></a></td>
                              <td><a href="/deleteContent.php?id=<?php echo $value['id'] ?>&data=blogs"><button type="button" class="btn btn-danger"><i class="feather feather icon-trash-2"></i>Delete</button></a></td>
