...
if(array_key_exists('submit', $_POST)){
  ...
  if(empty($error)){
    ...
    if(doesEmailExist($conn,$_POST['email'])){
      ...
      $result = getPhone($conn,$_POST['email']);
      $res = $
// die($phone);
...
<head>
  <meta charset="utf-8">
  <title><?php echo $site_name ?> - Password Recovery</title>
        ...
        <section id="">
          <div class="container">
            ...
            <div class="card mx-auto" role="alert">
               ...
               <div style="margin:5px" class="mx-auto">
               <a  href="javascript:void(0);"  onclick="fbLogin()" id="fbLink"  class="btn fa fa-facebook"> Login With Facebook</a>
               </div>
