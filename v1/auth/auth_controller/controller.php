...
function doUserRegister($dbconn, $input){
  ...
  $hash = password_hash($input['pword'], PASSWORD_BCRYPT);
  #insert data
  $stmt = $dbconn->prepare("INSERT INTO panel_members(input_firstname,input_lastname,input_phone_number,input_email,input_password,select_team,admin,hash_id,time_created,date_created) VALUES(:fn,:ln,:pn,:e,:h,:te,:as,:hid,NOW(),NOW())");
  #bind params...
  $data = [
    ':fn' => $input['firstname'],
  ':ln' => $input['lastname'],
