...
require APP_PATH.'/v1/payment/include/Flutterwave-Rave-PHP-SDK/vendor/autoload.php'; // Uncomment this autoloader if you need it
...
$dotenv = new Dotenv\Dotenv(APP_PATH.'/ent/');
$dotenv->load();
/**
