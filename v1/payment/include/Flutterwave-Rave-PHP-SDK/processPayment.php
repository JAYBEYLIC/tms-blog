...
$getData = $_GET;
$postData = $_POST;
$publicKey = getenv('RAVE_KEY');
$secretKey = getenv('RAVE_SECRETE');
$success_url = "confirm_payment";
$failure_url = "failed";
// $env = "live"; // Remember to/ change this to 'live' when you are going live
//
...
if(!isset($_SESSION['publicKey']) ||!isset($_SESSION['secretKey'])){
  if(isset($_GET['cancelled'])){
    $data["status"] = "Unclear; With Timeout; and Cancelled: No SESSION available on payment process";
